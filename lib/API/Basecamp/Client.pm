# Basecamp Client Super Class
package API::Basecamp::Client;

use API::Basecamp::Class;
use API::Basecamp::Exception;
...
has url => (
    is       => 'ro',
    isa      => URL,
    default  => fun { Mojo::URL->new("https://basecamp.com") },
);
